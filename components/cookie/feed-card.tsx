    ...
    >
      ...
      <div className={cn(
        ...
        <div className="absolute top-2 left-2 sm:top-3 sm:left-3">
          <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 bg-white/90 backdrop-blur-sm rounded-full text-[10px] sm:text-xs font-medium text-foreground">
            {post.category}
          </span>
        </div>
      ...
      <div className="p-2 sm:p-3">
        <h3 className="font-bold text-xs sm:text-sm text-foreground leading-tight line-clamp-2 mb-2">
          {post.title}
        </h3>
